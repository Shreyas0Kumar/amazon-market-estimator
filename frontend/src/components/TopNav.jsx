...
export default function TopNav({ query, darkMode, onToggleDark, onNewAnalysis }) {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, minWidth: 0 }}>
        ...
        <span style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--tx-4)' }}>analyzing</span>
        <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ width: 1, height: 14, background: 'var(--line-2)', margin: '0 2px' }} />

        {/* GitHub */}
        <NavIcon href="https://github.com/Shreyas0Kumar/amazon-market-estimator" title="GitHub" darkMode={darkMode}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="var(--tx-3)">
        ...
        {/* LinkedIn */}
        <NavIcon href="https://www.linkedin.com/in/shreyas0kumar/" title="LinkedIn" darkMode={darkMode}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="var(--tx-3)">
        ...
        >
          {darkMode ? (
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="var(--tx-3)" strokeWidth="2">
...
function NavIcon({ href, title, children }) {
  return (
